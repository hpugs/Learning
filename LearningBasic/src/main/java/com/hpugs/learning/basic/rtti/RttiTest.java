package com.hpugs.learning.basic.rtti;
...
//        classLoad();
    ...
    private static void classLoad() throws Throwable {
        Class rttiTest = Class.forName("com.hpugs.learning.basic.rtti.RttiTest");
        ...
        Class<?> initable3 = Class.forName("com.hpugs.learning.basic.rtti.RttiTest$Initable3");
